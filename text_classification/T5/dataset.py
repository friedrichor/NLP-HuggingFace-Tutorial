...
class MyDataset(Dataset):
    def __init__(self, data: List[Dict], tokenizer: T5Tokenizer, classes_map: Dict, prefix_text: str):
        ...
        # self.labels_map = {0: "anger", 1: "joy", 2: "optimism", 3: "sadness"}
    ...
    def __getitem__(self, index):
        ...
        labels_id = self.tokenizer.encode(text=self.labels_map[label], add_special_tokens=False)
    ...
    def collate_fn(self, batch):
        ...
        input_ids_pad = pad_sequence(input_ids_list, batch_first=True, padding_value=self.tokenizer.eos_token_id)
        ...
        labels_pad = pad_sequence(labels_list, batch_first=True, padding_value=self.tokenizer.eos_token_id)
