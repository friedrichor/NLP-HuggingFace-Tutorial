...
def main(args):
    ...
    # dataset, dataloader
    train_set = MyDataset(train_data, tokenizer, args.template, classes_labels)
    ...
    valid_set = MyDataset(valid_data, tokenizer, args.template, classes_labels)
